...
#takes in the initial position of the Pacman and its initial direction as the argument
    ...
    def __eq__(self, other): #used to compare two directions
        if other == None: return False
        return (self.pos == other.pos and self.direction == other.direction)

    def __hash__(self): #use to convert the pos and direction into a dictionary
        x = hash(self.pos)
        y = hash(self.direction)
        return hash(x + 13 * y)

    def __str__(self): #return the string of the pos and direction attributes
